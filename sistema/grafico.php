    ...
    function drawChart() {
      var data = google.visualization.arrayToDataTable([
        ...
        if(isset($cod_emp) && $cod_emp == 0 ){
          ...
          BETWEEN DATE_FORMAT('$anoAtual-$i-01', '%Y-%m-d') AND DATE_FORMAT('$anoAtual-$i-31', '%Y-%m-d')) AS RECEITA, 
          ...
          BETWEEN DATE_FORMAT('$anoAtual-$i-01', '%Y-%m-d') AND DATE_FORMAT('$anoAtual-$i-31', '%Y-%m-d')) AS DESPESA";
