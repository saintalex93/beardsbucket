...
<?php
             ...
             $cSQ ='SELECT USR_FOTO, USR_COD FROM USUARIO WHERE USR_COD='.$cod;
             $data = mysqli_query($conecta, $cSQ); 
             $oDdos = mysqli_fetch_assoc($data);   
                            
             echo  '<div class="camera1  border-white" ' .$cAlterar. '; document.all.codigo.value ='.  $oDdos['USR_COD'] .  '"> <img src="' . $oDdos['USR_FOTO'] . '"  class=" avatar border-white"  onerror=\'this.src="img/problema.png"\') ></div><br>'
?>
