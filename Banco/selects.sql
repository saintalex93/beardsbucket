...
LANCAMENTO.CAT_COD, CLI_COD, CNT_COD, LANCAMENTO.USR_COD, USR_NOME, CATEGORIA.CAT_COD, CAT_NOME, COD_EMPRESA, EMP_NOME_EMPRESA
 ...
 SELECT (SELECT SUM(LCT_VLRTITULO) from LANCAMENTO WHERE LCT_TIPO = 'Receita' AND  AND DATE_FORMAT(LCT_DTVENC, '%Y-%m-d')
 ...
 BETWEEN DATE_FORMAT('2017-10-01', '%Y-%m-d') AND DATE_FORMAT('2017-10-31', '%Y-%m-d')) AS DESPESA
